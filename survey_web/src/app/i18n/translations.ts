...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  hi: {
    ...
    'chk.previous': 'पीछे',
    'chk.next': 'आगे बढ़ें',
    'chk.skipNext': 'अगला प्रश्न',
    'chk.save': 'सेव करें',
    'chk.update': 'अपडेट करें',
    'chk.remark.label': 'टिप्पणी',
    'chk.remark.placeholder': 'यदि कोई विशेष टिप्पणी हो तो यहाँ लिखें…',
    'chk.answer.placeholder': 'अपना उत्तर लिखें…',
    'chk.answer.selectPlaceholder': 'चुनें',
    'chk.answer.length': 'लंबाई (फीट)',
    'chk.answer.width': 'चौड़ाई (फीट)',
    'chk.empty': 'कोई प्रश्न उपलब्ध नहीं है।',
    'chk.validation.answerRequired': 'कृपया हाँ या नहीं चुनें।',
    'chk.validation.answerRequired.generic': 'कृपया उत्तर चुनें।',
    'chk.validation.photoRequired': 'हाँ चुनने पर फ़ोटो आवश्यक है।',
    'chk.validation.photoRequired.generic': 'फ़ोटो आवश्यक है।',
    ...
    'ci.photoHint.generic': '* फ़ोटो अनिवार्य है',
  ...
  en: {
    ...
    'chk.next': 'Next',
    'chk.skipNext': 'Next question',
    'chk.save': 'Save',
    'chk.update': 'Update',
    'chk.remark.label': 'Remark (optional)',
    'chk.remark.placeholder': 'Write any additional remark here…',
    'chk.answer.placeholder': 'Enter your answer…',
    'chk.answer.selectPlaceholder': 'Select',
    'chk.answer.length': 'Length (ft)',
    'chk.answer.width': 'Width (ft)',
    'chk.empty': 'No questions available.',
    'chk.validation.answerRequired': 'Please select Yes or No.',
    'chk.validation.answerRequired.generic': 'Please select an answer.',
    'chk.validation.photoRequired': 'A photo is required when you select Yes.',
    'chk.validation.photoRequired.generic': 'A photo is required.',
    ...
    'ci.photoHint.generic': '* Photo is mandatory',
